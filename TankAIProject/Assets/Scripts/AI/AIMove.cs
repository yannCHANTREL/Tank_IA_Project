...
public class AIMove : MonoBehaviour
{
    ...
    private void Move(Vector3 distance, Vector3 tankForward)
    {
        ...
        m_MoveAxis.m_Values[m_TankIndexManager.m_TankIndex-1] = Vector3.Dot(distance, tankForward) >= 0 != (m_MoveToFireRange && distance.magnitude - m_FirePlacementRange < 0)? 1 : -1;
    }
